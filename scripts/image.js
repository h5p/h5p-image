...
H5P.Image = function (params, contentPath) {
  ...
  else if (params.file.tmp !== undefined && params.file.tmp) {
    // TODO: Clean this up. (Libraries shouldn't have to worry about this. Make them work with content path only.)
    this.source = H5PEditor.filesPath + '/h5peditor/' + params.file.path;
  }
  else {
    this.source = contentPath + params.file.path;
  }
